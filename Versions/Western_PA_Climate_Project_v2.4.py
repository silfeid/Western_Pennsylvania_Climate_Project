...
def check_for_new_files():
    ...
    samesies = list_comparer(first_file_list, second_file_list)
    print(samesies)
...
def get_record_count():
    ...
    print('There are '+records_count+' records in the database; each record consists of 4 unique elements, meaning that there are '+data_points+' unique data points in the database. These records are drawn from '+stations_number+' distinct weather stations across Pennsylvania.')
